...
const AppContent: React.FC = () => {
  ...
  return (
    <div
      ...
      } flex flex-col antialiased m-0 p-0 font-sans selection:bg-emerald-100`}
    >
      {/* Active Screen Viewport (Full mobile viewport without fake frames or margins) */}
      <main className="w-full flex-1 flex flex-col relative overflow-x-hidden">
        {renderActiveScreen()}
      </main>
      ...
      {toastMessage && (
        <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-50 px-4 py-2.5 rounded-full bg-[#0C5A3E] text-white text-xs sm:text-sm font-bold shadow-xl flex items-center gap-2 animate-in fade-in slide-in-from-bottom-2 pointer-events-none">
